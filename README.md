...
不会吧！不会吧！4202年了不会还有人没有玩转相机吧 🤡🤡，富士、佳能、索尼、徕卡官方预设手到擒来 🤏🤏，快点和我一起玩转相机 🛹🛹。
...
|  参数  |      默认值       |                            可选值                            |                             备注                             |
| :----: | :---------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| camera | Fujifilm GFX 100S | ['Fujifilm GFX 100S', 'Sony ILCE-7', 'Sony ILCE-7RM5', 'Canon EOS R3', 'Canon EOS R5', 'Nikon Z 9', 'Leica SL2'] | 希望把照片修改为什么品牌的相机参数。linux环境运行可以把可选值其中一项作为camera参数传入。windows环境运行修改main.py第20行default的值进行替换 |
